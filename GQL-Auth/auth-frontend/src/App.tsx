...
const Dashboard: React.FC = () => {
  ...
  const [userData, setUserData] = useState<UserDbEntry[]>([]);
  ...
  const fetchUserData = async () => {
    try {
      ...
      const data = await graphqlRequest(USER_DB_QUERY, {}, token);
  ...
  return (
    <div style={styles.dashboard}>
      ...
      <div style={styles.userDataSection}>
        <h3>User Database</h3>

        {loading && <div style={styles.loading}>Loading user data...</div>}
            ...
            <table style={styles.table}>
              <thead>
                <tr style={styles.tableHeader}>
                  ...
                  <th style={styles.tableCell}>Join Date</th>
                </tr>
              </thead>
              <tbody>
                {userData.map((userEntry) => (
                  <tr key={userEntry.id} style={styles.tableRow}>
                    <td style={styles.tableCell}>{userEntry.id}</td>
                    <td style={styles.tableCell}>{userEntry.name}</td>
                    <td style={styles.tableCell}>{userEntry.email}</td>
                    ...
                    <td style={styles.tableCell}>{userEntry.department}</td>
                    <td style={styles.tableCell}>
                      <span
                        style={{
                          ...styles.badge,
                    ...
                    <td style={styles.tableCell}>{userEntry.joinDate}</td>
                  </tr>
                ))}
              </tbody>
            </table>
